        ...
        <div className="static">
            <div className="-mb-1 fixed z-10 bg-white bottom-0 w-full border-t border-gray-300 dark:border-gray-700">
                <ul className="list-none flex-row flex -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    ...
                    >
                        <span className="material-symbols-rounded block">tag</span>
                        <label>태그검색</label>
                    </Link>
                    </li>
                    <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                    ...
                    >
                        <span className="material-symbols-rounded block">sentiment_satisfied</span>
                        <label>My웹툰</label>
                    </Link>
                    </li>
                    <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                    ...
                    >
                        <span className="material-symbols-rounded block">grid_view</span>
                        <label>더보기</label>
                    </Link>
                    </li>
                </ul>
