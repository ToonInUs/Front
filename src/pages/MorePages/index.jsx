...
const MorePages = () => {
  ...
  let LoginLogoutBtn = () => {
    if (isLogin){
      // 로그인 상태면 로그아웃 버튼
      return(
        <Button text="로그아웃" color="bright" link="/" />
      )
    } else {
      // 로그아웃 상태면 로그인 버튼
      return(
        <Button text="로그인" color="bright" link="/login" />
      )
    }
  }
    ...
    <>
      <section className="border-b border-gray-300">
        ...
        <div className="content">
          {/* 사용자 이름 변경 */}
          <Button text={<><label className="align-middle text-xl">{}님</label><span className="align-middle material-symbols-rounded">arrow_forward_ios</span></>} link="username" />
